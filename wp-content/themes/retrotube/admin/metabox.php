...
function wpst_video_information_metabox(){
	...
	$xbox->add_field(array(
		...
		'type' => 'file',
		/*'desc' => __('Paste here the video URL (<strong>MP4</strong>, <strong>YouTube</strong>, <strong>Google Drive</strong>, <strong>Pornhub</strong>, <strong>Redtube</strong>, <strong>Spankwire</strong>, <strong>Tube8</strong>, <strong>Xhamster</strong>, <strong>Xvideos</strong> or <strong>Youporn</strong> link) or upload a video file.', 'wpst')*/
		'desc' => __('Paste here the video URL or upload a video file.', 'wpst') . '<ul class="video-icons"><li><img src="' . get_template_directory_uri() . '/admin/assets/img/metabox/mp4.jpg"></li><li><img src="' . get_template_directory_uri() . '/admin/assets/img/metabox/youtube.jpg"></li><li><img src="' . get_template_directory_uri() . '/admin/assets/img/metabox/google-drive.jpg"></li><li><img src="' . get_template_directory_uri() . '/admin/assets/img/metabox/pornhub.jpg"></li><li><img src="' . get_template_directory_uri() . '/admin/assets/img/metabox/redtube.jpg"></li><li><img src="' . get_template_directory_uri() . '/admin/assets/img/metabox/spankwire.jpg"></li><li><img src="' . get_template_directory_uri() . '/admin/assets/img/metabox/tube8.jpg"></li><li><img src="' . get_template_directory_uri() . '/admin/assets/img/metabox/xhamster.jpg"></li><li><img src="' . get_template_directory_uri() . '/admin/assets/img/metabox/xvideos.jpg"></li><li><img src="' . get_template_directory_uri() . '/admin/assets/img/metabox/youporn.jpg"></li></ul>'
	));
	...
	$xbox->add_field(array(
		...
		'options' => array(
			...
			'preview_size' => array( 'width' => '320px', 'height' => '200px' )//Default: array( 'width' => '64px', 'height' => 'auto' )
		)
	));
