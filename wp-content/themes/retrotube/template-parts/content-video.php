...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?> itemprop="video" itemscope itemtype="http://schema.org/VideoObject">
	<header class="entry-header">
		...
		<?php if( wp_is_mobile() ) : ?>
			...
			<?php elseif( xbox_get_field_value( 'wpst-options', 'under-player-ad-mobile' ) != '' ) : ?>
				<div class="under-player-ad-mobile">
	...
	<div class="entry-content">		
		...
		<?php if( !wp_is_mobile() ) : ?>
			...
			<div class="tab-content">
				<div id="video-about" class="width<?php if( xbox_get_field_value( 'wpst-options', 'enable-rating-system' ) == 'off' ) : ?>100<?php else: ?>70<?php endif; ?>">
					<?php $content = get_the_content();
					$video_in_content = false;
					$video_code = array();
					if( preg_match("/\[video.+\]/", get_the_content(), $video_code) ){
