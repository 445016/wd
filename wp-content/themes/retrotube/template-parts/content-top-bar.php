            ...
            <?php if( xbox_get_field_value( 'wpst-options', 'enable-membership' ) == 'on' ) : ?>
                <div class="membership">                                                          
                    <?php if( is_user_logged_in() ) : ?>
                        <span class="welcome"><i class="fa fa-user"></i> <?php echo wp_get_current_user()->display_name; ?></span>
                        ...
                        <?php if( xbox_get_field_value( 'wpst-options', 'display-my-channel-link' ) == 'on' ) : ?>        
                            <a href="<?php echo get_author_posts_url(get_current_user_id()); ?>"><i class="fa fa-video-camera"></i> <span class="topbar-item-text"><?php esc_html_e('My Channel', 'wpst'); ?></span></a>
                        <?php endif; ?>
